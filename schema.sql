...
CREATE TABLE IF NOT EXISTS accounts (
    ...
    cash_mode TEXT DEFAULT 'SETTLED' CHECK (cash_mode IN ('SETTLED', 'TOTAL')),
    capital_utilization DECIMAL(5,4) NOT NULL DEFAULT 1.00,
...
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS cash_mode TEXT DEFAULT 'SETTLED';
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS capital_utilization DECIMAL(5,4) NOT NULL DEFAULT 1.00;
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS allow_overnight BOOLEAN NOT NULL DEFAULT TRUE;
